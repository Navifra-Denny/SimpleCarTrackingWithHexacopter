...
void VisualizeControl::MarkerInit()
{
    ...
    m_target_trajectory.line_strip.color.a = 1.0;
    ...
    m_target_trajectory.orientation.scale.x = 1.0;
    m_target_trajectory.orientation.scale.y = 0.2;
    m_target_trajectory.orientation.scale.z = 0.2;
    m_target_trajectory.orientation.color.r = 1.0f;
    m_target_trajectory.orientation.color.g = 0.0f;
    m_target_trajectory.orientation.color.b = 0.0f;
    m_target_trajectory.orientation.color.a = 1.0;
    ...
    m_target_trajectory.center_point.color.a = 1.0;
    ...
    m_ego_trajectory.line_strip.color.a = 1.0;
    ...
    m_ego_trajectory.orientation.scale.x = 1.0;
    m_ego_trajectory.orientation.scale.y = 0.2;
    m_ego_trajectory.orientation.scale.z = 0.2;
    m_ego_trajectory.orientation.color.r = 1.0f;
    m_ego_trajectory.orientation.color.g = 0.0f;
    m_ego_trajectory.orientation.color.b = 0.0f;
    m_ego_trajectory.orientation.color.a = 1.0;
    ...
    m_target_waypoints.line_strip.color.a = 1.0;
...
void VisualizeControl::TimerCallback(const ros::TimerEvent& event)
{
    ...
    m_target_trajectory.self.markers.push_back(m_target_trajectory.line_strip);
    m_target_trajectory.self.markers.push_back(m_target_trajectory.orientation);
    m_target_trajectory.self.markers.push_back(m_target_trajectory.center_point);

    m_ego_trajectory.self.markers.clear();
    m_ego_trajectory.self.markers.push_back(m_ego_trajectory.line_strip);
    m_ego_trajectory.self.markers.push_back(m_ego_trajectory.orientation);

    m_target_waypoints.self.markers.clear();
    m_target_waypoints.self.markers.push_back(m_target_waypoints.line_strip);
