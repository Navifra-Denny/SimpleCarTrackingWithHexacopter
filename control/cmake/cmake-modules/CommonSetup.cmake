...
macro(IncludeEigen)
    include_directories(${CONTROL_ROOT}/AirLib/deps/eigen3)
endmacro(IncludeEigen)

macro(AddExecutableSource)
    set(PROJECT_CPP ${PROJECT_NAME}_sources)
    file(GLOB_RECURSE PROJECT_CPP "${CONTROL_ROOT}/${PROJECT_NAME}/*.cpp")
...
macro(CommonSetup)
    ...
    find_path(CONTROL_ROOT NAMES AirSim.sln PATHS ".." "../.." "../../.." "../../../.." "../../../../.." "../../../../../..")
    message(STATUS "found CONTROL_ROOT=${CONTROL_ROOT}")
    ...
    set(RPC_LIB_INCLUDES " ${CONTROL_ROOT}/external/rpclib/${RPCLIB_VERSION_FOLDER}/include")
